...
\caption{Complete statistical comparison of the 78 retained handcrafted features.}
...
\footnotesize
\textit{Note.} Features are ordered by descending absolute point-biserial correlation with retraction status. 

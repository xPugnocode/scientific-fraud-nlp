...
\begin{figure}[H]
    ...
    \caption{Distributions of three linguistic features selected to represent the strongest associations distinguishing between the fraudulent and genuine papers.}
